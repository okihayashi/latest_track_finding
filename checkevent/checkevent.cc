...
int main(int argc, char** argv){
    ...
    TH1D* h1 = new TH1D("h1","h1",50, 0, 105);
	...
	for(int i=0;i<CDCcell_nHits;i++){
	    ...
	    h1->Fill(CDCcell_pz_signal.at(0)*1e3);

	}
        CDCcell_x.clear();            
        CDCcell_y.clear();            
        CDCcell_signalhits_x.clear(); 
        CDCcell_signalhits_y.clear(); 
        CDCcell_bghits_x.clear();     
        CDCcell_bghits_y.clear();     
